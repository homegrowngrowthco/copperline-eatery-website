# Backlink & Citation Outreach Pack — Copperline Eatery

Prepared 2026-07-03. Everything below needs a human sender (accounts, email, or membership), so it's staged here ready to fire. Standard details for every submission:

> **The Copperline Eatery** · 409 Broadway, Chicopee, MA 01020 · (413) 594-8332 · copperlineeatery@yahoo.com · https://copperlineeatery.com (always https, never http, never "Broadway St")

## Tier 1 — free, high-relevance (do first)

| Target | Action | Who |
|---|---|---|
| Macaroni KID Chicopee-Holyoke-Westfield | They publish "Five Chicopee Breakfast Spots We Love" (currently lists competitors). Pitch inclusion: https://chicopee.macaronikid.com — use the contact form; angle: MassLive Best Breakfast winner + family-owned 33 years, kid-friendly ($7.50 children's menu). | Ian |
| Nextdoor business page | Claim the auto-generated page (nextdoor.com/pages/copper-line-eatery-chicopee-ma) — free, fixes the "Copper Line" name variant, adds a citation + neighborhood visibility. | Dad (or Ian w/ business email) |
| Bing Places | Claim/verify (free; imports from GBP). Check name/https URL. | Dad |
| Apple Business Connect | Claim (free; Apple Maps listing feeds Siri/Apple Maps answers). | Dad |
| Yelp: fix "409 Broadway St" → "409 Broadway" + website to https | Owner account edit. | Dad |
| TripAdvisor: website field → https | Owner account edit. | Dad |
| The Q 99.7 directory: website → https | Ask station contact. | Ian |

## Tier 2 — local institutional links (email pitches)

**Greater Chicopee Chamber of Commerce** — membership (~$200-300/yr) includes a member-directory listing (followed link) + event catering visibility. Decide if the membership pays for itself as a catering lead channel; the Chamber itself books caterers for mixers.

**Explore Western Mass (exploreewesternmass.com) / Valley Visitor sites** — submit to their dining listings.

**Venue "preferred caterer" pages** — the highest-value catering backlinks. Draft email below; send to function halls, churches with halls, and event spaces you've actually served (list from Dad's records):
...
## Tier 3 — press / seasonal

- **MassLive & WWLP**: already link (award coverage). When the next Readers' Choice voting opens, promote it (a fresh win = fresh links).
